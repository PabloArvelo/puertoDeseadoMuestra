...
fetch(`/fetch/buscaAsociado/${idAsoc}`)
...
function cargarPrendaSelect() {
    fetch(`/fetch/ropaEnStock`)  // aca tengo que cambien la url al nuevo query
...
prendaSelect.addEventListener("change", () => {
    ...
    fetch(`/fetch/listadoEstadosPrendaEnStock/${idPrendaSelect}`)
        .then((response) => response.json())
        .then((data) => iterar(data))
...
estadoSelect.addEventListener("change", () => {
    ...
    fetch(`/fetch/tallesDisponibles/${idPrendaSelect}/${valorEstado}`)
        .then((response) => response.json())
...
talleSelect.addEventListener("change", () => {
    ...
    console.log("ante todo")
    console.log(idPrendaSelect);
    console.log(valorEstado);
    console.log(idTalleSelect);

    // consulto y obtengo de la BBDD el stock disponible filtrando por prenda, estado y talle 
    fetch(`/fetch/stockPorPrendaYEstadoYTalle/${idPrendaSelect}/${valorEstado}/${idTalleSelect}`)
        .then((response) => response.json())
        .then((data) => {    
            console.log(data);
            stockInput.value = '';
...
async function guardarPrendasAsignadas() {
    ...
    try {
        const response = await fetch(`/fetch/movimientoPrenda`, {
            method: 'POST',
            headers: {
