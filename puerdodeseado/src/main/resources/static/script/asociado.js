...
function capturaDatosParaModal() {
    ...
    console.log("el salario minimo es " +salMinFuente)

    let salMinActualizar = document.getElementById("salMinActualizar");
    //salMinActualizar.value = salMinFuente.value;
    salMinActualizar.value = document.getElementById("salMinFuente").value;
    console.log("el salario actualizar minimo es " +salMinActualizar.value)
